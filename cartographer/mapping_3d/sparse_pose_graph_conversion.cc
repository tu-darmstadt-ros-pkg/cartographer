...
void SparsePoseGraphConversion::AddScan(
      common::Time time,
...
void SparsePoseGraphConversion::AddImuData(const int trajectory_id, common::Time time,
...
void SparsePoseGraphConversion::ComputeConstraint(const mapping::NodeId& node_id,
                                                  const mapping::SubmapId& submap_id) {
...
SparsePoseGraphConversion::GetTrajectoryNodes() {
  common::MutexLocker locker(&mutex_);
...
std::vector<std::vector<int>> SparsePoseGraphConversion::GetConnectedTrajectories() {
  common::MutexLocker locker(&mutex_);
