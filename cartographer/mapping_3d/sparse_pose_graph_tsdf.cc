...
SparsePoseGraphTSDF::SparsePoseGraphTSDF(
...
void SparsePoseGraphTSDF::AddWorkItem(std::function<void()> work_item) {
...
void SparsePoseGraphTSDF::AddImuData(const mapping::Submaps* trajectory,
                                 common::Time time,
...
void SparsePoseGraphTSDF::ComputeConstraint(const int scan_index,
...
void SparsePoseGraphTSDF::WaitForAllComputations() {
...
void SparsePoseGraphTSDF::RunFinalOptimization() {
  WaitForAllComputations();
...
void SparsePoseGraphTSDF::RunOptimization() {
...
bool SparsePoseGraphTSDF::HasNewOptimizedPoses() {
  common::MutexLocker locker(&mutex_);
...
SparsePoseGraphTSDF::GetScanMatchingProgress() {
...
std::vector<mapping::TrajectoryNode> SparsePoseGraphTSDF::GetTrajectoryNodes() {
  common::MutexLocker locker(&mutex_);
  return trajectory_nodes_;
}

std::vector<SparsePoseGraphTSDF::Constraint> SparsePoseGraphTSDF::constraints() {
  return constraints_;
}

transform::Rigid3d SparsePoseGraphTSDF::GetLocalToGlobalTransform(
...
SparsePoseGraphTSDF::GetConnectedTrajectories() {
  common::MutexLocker locker(&mutex_);
  return connected_components_;
}

std::vector<transform::Rigid3d> SparsePoseGraphTSDF::GetSubmapTransforms(
    const mapping::Submaps& submaps) {
  common::MutexLocker locker(&mutex_);
  return ExtrapolateSubmapTransforms(optimized_submap_transforms_, submaps);
}

std::vector<transform::Rigid3d> SparsePoseGraphTSDF::ExtrapolateSubmapTransforms(
