...
#ifndef CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_VOXBLOX_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
#define CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_VOXBLOX_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
...
class RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder
    : public LocalVoxbloxTSDFTrajectoryBuilderInterface {
 public:
  explicit RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder(
      const proto::LocalTrajectoryBuilderOptions& options);
  ~RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder() override;

  RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder(const RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder&) =
      delete;
  RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder& operator=(
      const RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder&) = delete;
 ...
 private:
  ...
  std::unique_ptr<mapping_3d::VoxbloxTSDFs> submaps_;
...
#endif  // CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_VOXBLOX_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
