...
#ifndef CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_CONVERSION_H_
#define CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_CONVERSION_H_
...
class SparsePoseGraphConversion : public mapping::SparsePoseGraph {
 public:
  ...
  SparsePoseGraphConversion& operator=(const SparsePoseGraphConversion&) = delete;
...
#endif  // CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_CONVERSION_H_
