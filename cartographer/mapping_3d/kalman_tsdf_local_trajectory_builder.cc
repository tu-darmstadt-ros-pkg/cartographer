...
void KalmanTSDFLocalTrajectoryBuilder::AddImuData(
...
KalmanTSDFLocalTrajectoryBuilder::AddRangefinderData(
...
const KalmanTSDFLocalTrajectoryBuilder::PoseEstimate&
KalmanTSDFLocalTrajectoryBuilder::pose_estimate() const {
