...
#ifndef CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_VOXBLOX_CONVERSION_H_
#define CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_VOXBLOX_CONVERSION_H_
...
class SparsePoseGraphVoxbloxConversion : public mapping::SparsePoseGraph {
 public:
  SparsePoseGraphVoxbloxConversion(
      const mapping::proto::SparsePoseGraphOptions& options,
      common::ThreadPool* thread_pool);
  ~SparsePoseGraphVoxbloxConversion() override;

  SparsePoseGraphVoxbloxConversion(const SparsePoseGraphVoxbloxConversion&) = delete;
  SparsePoseGraphVoxbloxConversion& operator=(const SparsePoseGraphVoxbloxConversion&) = delete;
 ...
 private:
  struct SubmapState {
    const VoxbloxTSDF* submap = nullptr;
  ...
  void GrowSubmapTransformsAsNeeded(
      const std::vector<const VoxbloxTSDF*>& insertion_submaps) REQUIRES(mutex_);
  ...
  void ComputeConstraintsForOldScans(const VoxbloxTSDF* submap) REQUIRES(mutex_);
  ...
  sparse_pose_graph::ConstraintBuilderVoxbloxConversion constraint_builder_ GUARDED_BY(mutex_);
...
#endif  // CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_VOXBLOX_CONVERSION_H_
