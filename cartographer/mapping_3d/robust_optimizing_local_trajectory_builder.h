...
#ifndef CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_LOCAL_TRAJECTORY_BUILDER_H_
#define CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_LOCAL_TRAJECTORY_BUILDER_H_
...
class RobustOptimizingLocalTrajectoryBuilder
    : public LocalTrajectoryBuilderInterface {
 public:
  explicit RobustOptimizingLocalTrajectoryBuilder(
      const proto::LocalTrajectoryBuilderOptions& options);
  ~RobustOptimizingLocalTrajectoryBuilder() override;

  RobustOptimizingLocalTrajectoryBuilder(const RobustOptimizingLocalTrajectoryBuilder&) =
      delete;
  RobustOptimizingLocalTrajectoryBuilder& operator=(
      const RobustOptimizingLocalTrajectoryBuilder&) = delete;
