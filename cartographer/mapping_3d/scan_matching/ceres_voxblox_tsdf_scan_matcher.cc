...
void CeresVoxbloxTSDFScanMatcher::setupProblem(const transform::Rigid3d& previous_pose,
...
void CeresVoxbloxTSDFScanMatcher::EvaluateGradient(const transform::Rigid3d& previous_pose,
           const transform::Rigid3d& initial_pose_estimate,
           const std::vector<PointCloudAndVoxbloxTSDFPointers>&
               point_clouds_and_tsdfs,
           float max_truncation_distance,
