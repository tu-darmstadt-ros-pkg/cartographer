...
#ifndef CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_FAST_CORRELATIVE_CONVERSION_SCAN_MATCHER_H_
#define CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_FAST_CORRELATIVE_CONVERSION_SCAN_MATCHER_H_
...
class FastCorrelativeConversionScanMatcher {
 public:
  ...
  FastCorrelativeConversionScanMatcher& operator=(const FastCorrelativeConversionScanMatcher&) =
      delete;
...
#endif  // CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_FAST_CORRELATIVE_CONVERSION_SCAN_MATCHER_H_
