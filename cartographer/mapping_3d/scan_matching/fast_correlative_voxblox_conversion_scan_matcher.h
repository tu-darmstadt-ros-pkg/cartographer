...
#ifndef CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_FAST_CORRELATIVE_VOXBLOX_CONVERSION_SCAN_MATCHER_H_
#define CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_FAST_CORRELATIVE_VOXBLOX_CONVERSION_SCAN_MATCHER_H_
...
class FastCorrelativeVoxbloxConversionScanMatcher {
 public:
  ...
  FastCorrelativeVoxbloxConversionScanMatcher(const FastCorrelativeVoxbloxConversionScanMatcher&) = delete;
  FastCorrelativeVoxbloxConversionScanMatcher& operator=(const FastCorrelativeVoxbloxConversionScanMatcher&) =
      delete;
...
#endif  // CARTOGRAPHER_MAPPING_3D_SCAN_MATCHING_FAST_CORRELATIVE_VOXBLOX_CONVERSION_SCAN_MATCHER_H_
