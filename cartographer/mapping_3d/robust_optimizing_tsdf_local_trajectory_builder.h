...
#ifndef CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
#define CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
...
class RobustOptimizingTSDFLocalTrajectoryBuilder
    : public LocalTSDFTrajectoryBuilderInterface {
 public:
  explicit RobustOptimizingTSDFLocalTrajectoryBuilder(
      const proto::LocalTrajectoryBuilderOptions& options);
  ~RobustOptimizingTSDFLocalTrajectoryBuilder() override;

  RobustOptimizingTSDFLocalTrajectoryBuilder(const RobustOptimizingTSDFLocalTrajectoryBuilder&) =
      delete;
  RobustOptimizingTSDFLocalTrajectoryBuilder& operator=(
      const RobustOptimizingTSDFLocalTrajectoryBuilder&) = delete;
...
#endif  // CARTOGRAPHER_MAPPING_3D_ROBUST_OPTIMIZING_LOCAL_TRAJECTORY_BUILDER_H_
