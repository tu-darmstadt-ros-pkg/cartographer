...
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder(
    ...
    : options_(options),
      ...
      submaps_(common::make_unique<VoxbloxESDFs>(options.tsdfs_options())),
      num_accumulated_(0),
      num_update_scans_(0),
...
const VoxbloxESDFs *RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::submaps() const {
  return submaps_.get();
}

void RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::AddImuData(
...
void RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::AddOdometerData(
...
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::AddRangefinderData(
...
void RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::RemoveObsoleteSensorData() {
  if (imu_data_.empty()) {
    batches_.clear();
    return;
  }
...
void RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::TransformStates(
...
std::unique_ptr<RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::InsertionResult>
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::MaybeOptimize(const common::Time time, const Eigen::Vector3f& origin) {
...
std::unique_ptr<RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::InsertionResult>
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::AddAccumulatedRangeData(
...
const RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::PoseEstimate&
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::pose_estimate() const {
  return last_pose_estimate_;
}

std::unique_ptr<RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::InsertionResult>
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::InsertIntoSubmap(
...
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::State
RobustOptimizingVoxbloxESDFLocalTrajectoryBuilder::PredictState(const State& start_state,
