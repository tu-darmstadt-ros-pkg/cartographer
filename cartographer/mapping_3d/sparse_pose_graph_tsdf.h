...
#ifndef CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_TSDF_H_
#define CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_TSDF_H_
...
class SparsePoseGraphTSDF : public mapping::SparsePoseGraph {
 public:
  SparsePoseGraphTSDF(
      const mapping::proto::SparsePoseGraphOptions& options,
      common::ThreadPool* thread_pool,
      std::deque<mapping::TrajectoryNode::ConstantData>* constant_node_data);
  ~SparsePoseGraphTSDF() override;

  SparsePoseGraphTSDF(const SparsePoseGraphTSDF&) = delete;
  SparsePoseGraphTSDF& operator=(const SparsePoseGraphTSDF&) = delete;
...
#endif  // CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_TSDF_H_
