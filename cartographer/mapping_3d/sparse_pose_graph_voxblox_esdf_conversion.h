...
#ifndef CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_VOXBLOX_ESDF_CONVERSION_H_
#define CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_VOXBLOX_ESDF_CONVERSION_H_
...
class SparsePoseGraphVoxbloxESDFConversion : public mapping::SparsePoseGraph {
 public:
  SparsePoseGraphVoxbloxESDFConversion(
      const mapping::proto::SparsePoseGraphOptions& options,
      common::ThreadPool* thread_pool);
  ~SparsePoseGraphVoxbloxESDFConversion() override;

  SparsePoseGraphVoxbloxESDFConversion(const SparsePoseGraphVoxbloxESDFConversion&) = delete;
  SparsePoseGraphVoxbloxESDFConversion& operator=(const SparsePoseGraphVoxbloxESDFConversion&) = delete;
 ...
 private:
  struct SubmapState {
    const VoxbloxESDF* submap = nullptr;
  ...
  void GrowSubmapTransformsAsNeeded(
      const std::vector<const VoxbloxESDF*>& insertion_submaps) REQUIRES(mutex_);
  ...
  void ComputeConstraintsForOldScans(const VoxbloxESDF* submap) REQUIRES(mutex_);
  ...
  sparse_pose_graph::ConstraintBuilderVoxbloxESDFConversion constraint_builder_ GUARDED_BY(mutex_);
...
#endif  // CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_VOXBLOX_ESDF_CONVERSION_H_
