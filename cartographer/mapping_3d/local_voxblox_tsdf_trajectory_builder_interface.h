...
#ifndef CARTOGRAPHER_MAPPING_3D_LOCAL_VOXBLOX_TSDF_TRAJECTORY_BUILDER_INTERFACE_H_
#define CARTOGRAPHER_MAPPING_3D_LOCAL_VOXBLOX_TSDF_TRAJECTORY_BUILDER_INTERFACE_H_
...
class LocalVoxbloxTSDFTrajectoryBuilderInterface {
 public:
  ...
  virtual ~LocalVoxbloxTSDFTrajectoryBuilderInterface() {}

  LocalVoxbloxTSDFTrajectoryBuilderInterface(const LocalVoxbloxTSDFTrajectoryBuilderInterface&) =
      delete;
  LocalVoxbloxTSDFTrajectoryBuilderInterface& operator=(
      const LocalVoxbloxTSDFTrajectoryBuilderInterface&) = delete;
  ...
  virtual const mapping_3d::VoxbloxTSDFs* submaps() const = 0;
  virtual const PoseEstimate& pose_estimate() const = 0;

 protected:
  LocalVoxbloxTSDFTrajectoryBuilderInterface() {}
...
#endif  // CARTOGRAPHER_MAPPING_3D_LOCAL_VOXBLOX_TSDF_TRAJECTORY_BUILDER_INTERFACE_H_
