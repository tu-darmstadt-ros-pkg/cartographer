...
const VoxbloxTSDFs *RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::submaps() const {
  return submaps_.get();
}

void RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::AddImuData(
...
void RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::AddOdometerData(
...
void RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::RemoveObsoleteSensorData() {
  if (imu_data_.empty()) {
    batches_.clear();
    return;
  }
...
void RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::TransformStates(
...
std::unique_ptr<RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::InsertionResult>
RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::MaybeOptimize(const common::Time time, const Eigen::Vector3f& origin) {
...
RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::pose_estimate() const {
...
RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::State
RobustOptimizingVoxbloxTSDFLocalTrajectoryBuilder::PredictState(const State& start_state,
