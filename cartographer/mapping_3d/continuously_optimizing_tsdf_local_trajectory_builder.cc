...
std::unique_ptr<ContinuouslyOptimizingTSDFLocalTrajectoryBuilder::InsertionResult>
ContinuouslyOptimizingTSDFLocalTrajectoryBuilder::MaybeOptimize(const common::Time time) {
...
void ContinuouslyOptimizingTSDFLocalTrajectoryBuilder::AddTrajectoryNodeIndex(
