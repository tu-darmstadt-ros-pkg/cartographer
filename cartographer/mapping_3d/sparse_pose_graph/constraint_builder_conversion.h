...
#ifndef CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_CONSTRAINT_BUILDER_CONVERSION_H_
#define CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_CONSTRAINT_BUILDER_CONVERSION_H_
...
class ConstraintBuilderConversion {
 public:
  using Constraint = mapping::SparsePoseGraph::Constraint;
  using Result = std::vector<Constraint>;

  ConstraintBuilderConversion(
      const mapping::sparse_pose_graph::proto::ConstraintBuilderOptions&
          options,
      common::ThreadPool* thread_pool);
  ~ConstraintBuilderConversion();

  ConstraintBuilderConversion(const ConstraintBuilderConversion&) = delete;
  ConstraintBuilderConversion& operator=(const ConstraintBuilderConversion&) = delete;
  ...
  void MaybeAddConstraint(const mapping::SubmapId& submap_id, const TSDF* const submap,
  ...
  void MaybeAddGlobalConstraint(
      const mapping::SubmapId& submap_id, const TSDF* const submap,
 ...
 private:
  ...
  void ComputeConstraint(
          const mapping::SubmapId& submap_id, const TSDF* const submap, const mapping::NodeId& node_id,bool match_full_submap,
...
#endif  // CARTOGRAPHER_MAPPING_3D_SPARSE_POSE_GRAPH_CONSTRAINT_BUILDER_CONVERSION_H_
