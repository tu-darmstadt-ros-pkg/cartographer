...
#ifndef CARTOGRAPHER_MAPPING_3D_KALMAN_VOXBLOX_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
#define CARTOGRAPHER_MAPPING_3D_KALMAN_VOXBLOX_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
...
// closure.
class KalmanVoxbloxTSDFLocalTrajectoryBuilder : public LocalVoxbloxTSDFTrajectoryBuilderInterface {
 public:
  explicit KalmanVoxbloxTSDFLocalTrajectoryBuilder(
      const proto::LocalTrajectoryBuilderOptions& options);
  ~KalmanVoxbloxTSDFLocalTrajectoryBuilder() override;

  KalmanVoxbloxTSDFLocalTrajectoryBuilder(const KalmanVoxbloxTSDFLocalTrajectoryBuilder&) = delete;
  KalmanVoxbloxTSDFLocalTrajectoryBuilder& operator=(const KalmanVoxbloxTSDFLocalTrajectoryBuilder&) =
      delete;
 ...
 private:
  ...
  std::unique_ptr<scan_matching::CeresVoxbloxTSDFScanMatcher> ceres_scan_matcher_;
...
#endif  // CARTOGRAPHER_MAPPING_3D_KALMAN_VOXBLOX_TSDF_LOCAL_TRAJECTORY_BUILDER_H_
